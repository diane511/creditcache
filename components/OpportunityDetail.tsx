...
export async function OpportunityDetail({
  ...
  const related = await relatedOpportunities(opportunity.slug);
      ...
      <div className="card strong">
        <div className="row" style={{ justifyContent: "space-between" }}>
          <div className="row">
            ...
            <Badge tone={opportunity.verified ? "good" : "warn"}>
              {opportunity.verified ? "Verified source" : "Review needed"}
            </Badge>
          </div>
        ...
        <div className="notice" style={{ marginTop: 16 }}>
          Credit Cache never guarantees approval, selection, winnings, or
          reimbursement. Always review official rules and eligibility directly
          on the source page.
        </div>
      ...
      <aside className="card">
        ...
        <div className="timeline">
          <div className="timeline-item">
            ...
            <div className="small">
              Bookmark it, then copy the deadline and document list into your
              checklist.
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="small">
              Collect transcripts, tax documents, IDs, and notes in one secure
              place.
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="small">
              Use the original listing link and keep your confirmation record.
            </div>
          </div>
        </div>
